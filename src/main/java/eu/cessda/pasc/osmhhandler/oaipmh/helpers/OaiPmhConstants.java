...
public class OaiPmhConstants {
  ...
  static final String CLASSIFICATIONS_XPATH = "//ddi:subject/ddi:topcClas";
  static final String KEYWORDS_XPATH = "//ddi:subject/ddi:keyword";
  ...
  static final String FILE_LANGUAGES_XPATH = "//ddi:codeBook/ddi:fileDscr/ddi:fileTxt/@xml:lang";
